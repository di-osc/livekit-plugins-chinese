...
class LLM(llm.LLM):
    def __init__(
        ...
        *,
        ...
        base_url: NotGivenOr[str] = "https://open.bigmodel.cn/api/paas/v4/",
        ...
        api_key = api_key if is_given(api_key) else os.getenv("ZHIPU_LLM_API_KEY")
        if api_key is None:
            raise ValueError("environment variable ZHIPU_LLM_API_KEY is not set")
